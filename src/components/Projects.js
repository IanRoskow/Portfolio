...
const projectMap = [
    {
        key: '1',
        title: 'My Portfolio',
        description: 'My portfolio site built with ReactJS.',
    ...
    },
    {
        ...
        description: 'A beautiful stock image finder built with React.',
    ...
    },
    {
        key: '4',
        title: 'Color Game',
        description: 'A simple game to test your RGB color skills.',
