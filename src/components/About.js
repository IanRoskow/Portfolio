...
const Wrapper = styled.div`
    ...
    transform: ${(props) =>
        props.topVisible ? 'rotate(0)' : 'rotate(-45deg)'};
    opacity: ${(props) => (props.topVisible ? '1' : '0')};
...
const About = () => {
    ...
    return (
        ...
        >
            <Container>
                <AnimatedHeader topVisible={topVisible}>
                    About Me
                </AnimatedHeader>
                <Grid>
                    <ProfilePhoto topVisible={picVisible}>
                        ...
                        <p style={{ padding: '10px' }}>
                            Highly skilled front-end developer proven by the
                            implementation of multiple web solutions with 1,000s
                            of active daily users for large corporate companies.
                            His work ethic, unique skillset, and proven track
                            record of exceeding client exceptions has made him a
                            desired project team member by many of his peers and
                            managers.
                        </p>
                    </ProfilePhoto>
                    <Stack topVisible={picVisible}>
                        ...
                        />
                        <StackRow
                            expert={['JavaScript', 'React', 'Redux', 'jQuery']}
                            knowledgable={['TypeScript']}
                        />
                        <StackRow knowledgable={['NodeJS', 'Express', 'PHP']} />
                    ...
                    <GridItem topVisible={topVisible} delay={'200ms'}>
                        ...
                        <p>
                            Quick page load times, lag free interaction, and
                            user content first.
                        </p>
                    </GridItem>
                    <GridItem topVisible={topVisible} delay={'400ms'}>
                        ...
                        <p>
                            Websites look great on any screen size, no device is
                            an after thought.
                        </p>
                    </GridItem>
                    <GridItem topVisible={topVisible} delay={'600ms'}>
                        ...
                        <p>
                            Easy to use and intuitive pages built on UX/UI
                            principles.
                        </p>
                    </GridItem>
                    <GridItem topVisible={topVisible} delay={'800ms'}>
                        ...
                        <p>
                            Improving user experience by making webpages come to
                            life.
                        </p>
                    </GridItem>
                </Grid>
