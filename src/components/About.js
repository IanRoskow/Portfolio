        ...
        <div className='about main'>
            <div className='aboutMe aboutContainer'>
                ...
                <div className="aboutSection">
                    ...
                    I graduated from Texas A&M University with a Bachelor's in Industrial Engineering and a Minor in Mathematics. During my time in school, I took a few programming classes and realized my natural aptitude for coding. I decided to finish my degree in Engineering for the job versatility it offered, but I always had the intention to become a developer. I was offered a job with a technology consulting firm, Hitachi Consulting, and used this as my way into the development world. For the next three years I worked as a web developer, creating custom web solutions for Fortune 500 companies. During that time I was able to work with a range of managers, teams, and technologies to create applications that helped add value to our clients' business processes. By the time I left the company I had established myself as a lead front-end developer and a front-end subject matter expert among my coworkers.<br/><br/>
